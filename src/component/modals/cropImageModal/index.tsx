...
const CropImageModal: React.FC<{ open: boolean }> = ({ open }) => {
  const dispatch = useDispatch();
  const setOpen = (open: boolean) => {
    dispatch(openCropImageModal(open));
  };
...
const mapStateToProps = (state: any) => {
  return { open: state.modal.openCropSocial };
};

export default connect(mapStateToProps)(CropImageModal);
